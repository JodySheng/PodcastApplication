...
<body>
	<form action="findpodcasts" method="post">
		<h1>Search for a Podcast by Author</h1>
		<p>
			<label for="">Podcast title</label>
        ...
        <table border="1">
            ...
            <c:forEach items="${podcasts}" var="podcast" >
                <tr>
                    ...
                    <td><a href="userpodcastreviews?podcastid=<c:out value="${podcast.getPodcastId()}"/>">PodcastReviews</a></td>
